...
Original file is located at
    https://colab.research.google.com/drive/1F0z94Bp7TrKQe9z-EtuFuvSKPapPmQn_
...
print(f"Your name is : {name} {surname}. You are {age} years old.")
...
raw_score = float(input("Enter your score: "))


def convert_grade(score: float) -> None:
    # Determine the grade
    if score >= 90:
        grade = 5
    elif score >= 80:
...
# Define variable
number = int(input("Enter a number: "))
divider = int(input(f"Enter a divider for {number}: "))

if number % divider == 0:
    result = f"{number} is divisible by {divider}"
else:
    result = f"{number} is not divisible by {divider}"
...
if sides[2] < (sides[0] + sides[1]):
    print(f"You can draw triangle with sides: {sides}")
    # Check the type of triangle
    if side1 == side2 == side3:
        triangle_type = "Equilateral"
    elif side1 == side2 or side1 == side3 or side2 == side3:
    ...
    print(f"You cannot draw triangle with sides: {sides}")
